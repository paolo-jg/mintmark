  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">2. Listing Details</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">3. Pricing & Format</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
        ...
        <Button type="submit" size="lg" className="w-full" disabled={submitting || !coinGrade}>
          {submitting ? <><Loader2 className="h-4 w-4 mr-2 animate-spin" /> Publishing…</> : 'Publish Listing'}
        </Button>
      </form>
    </div>
  )
